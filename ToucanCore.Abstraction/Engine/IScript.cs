...
{
    public interface IScriptPro : IScript
    {
        /// <summary>
        /// for persistence
        /// </summary>
        ...
        Configuration.HardwareConfig HardwareConfig { get; set; }
    ...
    public interface IScript : ICloneable
    {
        ...
        /// </summary>
        StationConfig StationConfig { get; set; }

        /// <summary>
        /// this would update outside, the default is from SystemConfig
        /// For prevent Wrong infomation, which could get from remote server
        /// </summary>
        SFCsConfig SFCsConfig { get; set; }
