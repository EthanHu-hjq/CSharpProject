...
{
    /// <summary>
    /// 1ED7CF-TYM-ATC10.pdf
    /// </summary>
    public class ATC10 : TF_Base, IFixture, ILockableFixture
    {
        readonly static string FilePath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonDocuments), "ATC10.xml");
        public FixtureManipulationConfig ManipulationConfig { get; } = new FixtureManipulationConfig(new string[] { "DUT Inned", "DUT Inning", "Door Closed", "Lock Test" }, new string[] { "X3", "X10", "Y10", "M12" }, new string[] { "Door Open", "Start"}, new string[] { "X0", "X0" });  // Open Door and Close Door are both X0
        ...
        public string Support => "ATC10";
        public string Model => "ATC10";

        public string SN => "ATC10 01";
        ...
        public int CloseFrontDoor(int slot = 0)
        {
            ...
            var rtn = -1;
            var ch = ManipulationConfig.OutCommands["Start"];
        ...
        public int OpenFrontDoor(int slot = 0)
        {
            ...
            var ch = ManipulationConfig.OutCommands["Door Open"];
            PLC_Mitsubishi_FX.ParseChannel(ch, out PLC_Mitsubishi_FX.RegisterType type, out short address);
            return PLC.ForceStatus(type, address, true);
